...
import { sendRequest,showSentRequest,showReceiveRequest,acceptRequest } from '../controller/requests_controller.js';
...
router.post('/showReceiveRequest',fetchuser,showReceiveRequest);
